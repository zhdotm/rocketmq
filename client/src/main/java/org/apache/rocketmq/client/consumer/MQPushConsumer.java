...
public interface MQPushConsumer extends MQConsumer {
     ...
     * 注册并发消息事件监听器。
     *
     * @param messageListener 并发消息事件监听器
     */
     ...
     * 注册顺序消费事件监听器。
     *
     * @param messageListener 顺序消费事件监听器
     */
     ...
     *
     * @param topic         消息主题。
     * @param subExpression 消息过滤表达式，TAG或SQL92表达式。 subscription expression.it only support or operation such as "tag1 || tag2 || tag3" <br> if
