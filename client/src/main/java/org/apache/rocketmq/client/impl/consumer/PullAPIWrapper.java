...
public class PullAPIWrapper {
    ...
    public PullResult pullKernelImpl(
        ...
        //第六步：根据brokerName、BrokerId从MQClientInstance中获取Broker地址，
        // 在整个RocketMQ Broker的部署结构中，相同名称的Broker构成主从结构，其BrokerId会不一样，在每次拉取消息后，会给出一个建议，下次是从主节点还是从节点拉取
        ...
        if (findBrokerResult != null) {
            ...
            //第七步：如果消息过滤模式为类过滤，则需要根据主题名称、broker地址找到注册在Broker上的FilterServer地址，从FilterServer上拉取消息，否则从Broker上拉取消息。
